                ...
                <form action="atualiza-doc.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="rg" class="form-control" id="rg" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="titulo" class="form-control" id="titulo" aria-describedby="inputGroupFileAddon03"  aria-label="Upload">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="residencia" class="form-control" id="residencia" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="certidao">Certidão de Nascimento (Casamento)</label>
                            <input type="file" name="certidao" class="form-control" id="certidao" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="escolaridade">Comprovante de Escolaridade</label>
                            <input type="file" name="escolaridade[]" multiple class="form-control" id="escolaridade" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group  col-md-6">
                            <label for="carteiraVac">Carteira de Vacinação </label>
                            <input type="file" name="carteiraVac" class="form-control" id="carteiraVac" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="foto" class="form-control" id="foto" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
